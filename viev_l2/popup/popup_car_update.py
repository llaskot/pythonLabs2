...
class PopupCarUpdate(PopupCarAbstract):
    def __init__(self, parent, car: list):
        super().__init__(parent)
        self.car_data = car
        self.setWindowTitle("Update the car")
    ...
    def _on_save(self):
        try:
            create_car((self.car_data[0], self.model_input.text(), self.year_input.text(), self.color_input.text(),
